...
client_id = r'your client id' # Get from https://discordapp.com/developers/applications
client_secret = 'your secret key'
# change the redirect uri to where you will be deploying the application+/oauth_callback
redirect_uri=''
